...
elseif(RUNTIME_CHECK STREQUAL "asan" OR RUNTIME_CHECK STREQUAL "hwasan")
  ...
  set(RUNTIME_ASAN_ENV_OPTIONS "disable_coredump=0 detect_odr_violation=0 strict_string_checks=1 detect_stack_use_after_return=1 check_initialization_order=1 strict_init_order=1 detect_invalid_pointer_pairs=2 handle_abort=1 suppressions=${CMAKE_SOURCE_DIR}/tests/asan.supp")
...
elseif(RUNTIME_CHECK STREQUAL "tsan")
  ...
  set(RUNTIME_TSAN_ENV_OPTIONS "disable_coredump=0 history_size=4 second_deadlock_stack=1 handle_abort=1 suppressions=${CMAKE_SOURCE_DIR}/tests/tsan.supp")
